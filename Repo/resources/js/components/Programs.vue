                ...
                <div class="card-body">
                    ...
                    <table class="mb-0 table table-bordered">
                        ...
                        <tr v-for="program in programs" v-bind:key="program.id">
                                ...
                                <td><router-link :to="`/ProgramCourses/${program.Name}/${program.id}`">Go to {{program.Name}} Courses =></router-link></td>
...
<form @submit.prevent="addProgram" class="md-3">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="name" v-model="program.Name">
                 <input type="text" class="form-control" placeholder="code" v-model="program.Description">
                <input type="text" class="form-control" placeholder="description" v-model="program.Description">
            </div>
